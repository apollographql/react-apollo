...
var ReactSixteenAdapter = (function(_EnzymeAdapter) {
  ...
  function ReactSixteenAdapter() {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ReactSixteenAdapter.__proto__ || Object.getPrototypeOf(ReactSixteenAdapter)).call(this),
    );
          ...
          return {
            render: (function() {
              function render(el, context, callback) {
                if (instance === null) {
                  var ReactWrapperComponent = (0, _enzymeAdapterUtils.createMountWrapper)(
                    el,
                    options,
                  );
            ...
            simulateEvent: (function() {
              function simulateEvent(node, event, mock) {
                ...
                if (!eventFn) {
                  throw new TypeError(
                    "ReactWrapper::simulate() event '" + String(event) + "' does not exist",
                  );
                }
            ...
            render: (function() {
              function render(el, context) {
                if (options.context && (el.type.contextTypes || options.childContextTypes)) {
                  var childContextTypes = (0, _object2['default'])(
                    {},
                    el.type.contextTypes || {},
                    options.childContextTypes,
                  );
                  var ContextWrapper = (0, _enzymeAdapterUtils.createRenderWrapper)(
                    el,
                    context,
                    childContextTypes,
                  );
                  return _server2['default'].renderToStaticMarkup(
                    _react2['default'].createElement(ContextWrapper),
                  );
                }
      ...
      value: (function() {
        function nodeToElement(node) {
          ...
          return _react2['default'].createElement(
            node.type,
            (0, _enzymeAdapterUtils.propsWithKeysAndRef)(node),
          );
        }
