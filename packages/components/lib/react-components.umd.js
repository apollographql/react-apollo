(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@apollo/react-common'), require('tslib'), require('react'), require('prop-types'), require('apollo-client'), require('lodash.isequal'), require('ts-invariant')) :
    typeof define === 'function' && define.amd ? define(['exports', '@apollo/react-common', 'tslib', 'react', 'prop-types', 'apollo-client', 'lodash.isequal', 'ts-invariant'], factory) :
    (global = global || self, factory(global['react-components'] = {}, global.apolloReactCommon, global.tslib, global.React, global.PropTypes, global.apollo.core, global.isEqual, global.invariant));
}(this, function (exports, reactCommon, tslib, React, PropTypes, apolloClient, isEqual, tsInvariant) { 'use strict';
