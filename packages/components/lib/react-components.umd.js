(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@apollo/react-common'), require('tslib'), require('react'), require('prop-types'), require('apollo-client'), require('ts-invariant'), require('fast-json-stable-stringify')) :
    typeof define === 'function' && define.amd ? define(['exports', '@apollo/react-common', 'tslib', 'react', 'prop-types', 'apollo-client', 'ts-invariant', 'fast-json-stable-stringify'], factory) :
    (global = global || self, factory(global['react-components'] = {}, global.apolloReactCommon, global.tslib, global.React, global.PropTypes, global.apollo.core, global.invariant));
}(this, function (exports, reactCommon, tslib, React, PropTypes, apolloClient, tsInvariant) { 'use strict';
    ...
    var Query = (function (_super) {
            ...
            _this.startQuerySubscription = function (client) {
                ...
                _this.observableQuerySubscription = _this.observableQuery.subscribe({
                    ...
                    error: function (error) {
                        var previousResult = _this.previousResult;
                        if (!previousResult ||
                            previousResult.networkStatus === apolloClient.NetworkStatus.refetch) {
        ...
        Query.prototype.extractOptsFromProps = function (props) {
            ...
            process.env.NODE_ENV === "production" ? tsInvariant.invariant(this.operation.type === reactCommon.DocumentType.Query) : tsInvariant.invariant(this.operation.type === reactCommon.DocumentType.Query, "The <Query /> component requires a graphql query, but got a " + (this.operation.type === reactCommon.DocumentType.Mutation
                ? 'mutation'
                : 'subscription') + ".");
        ...
        Query.prototype.initializeObservableQuery = function (client, props, context) {
            ...
            if (!this.observableQuery) {
                ...
                this.previousOptions = tslib.__assign({}, options, { children: null });
        ...
        Query.prototype.updateObservableQuery = function (client, context) {
            ...
            var newOptions = tslib.__assign({}, this.extractOptsFromProps(this.props), { children: null });
    ...
    var Mutation = (function (_super) {
        tslib.__extends(Mutation, _super);
        function Mutation(props, context) {
            ...
            _this.mutate = function (options) {
                ...
                var mutateOptions = tslib.__assign({}, options);
                var refetchQueries = mutateOptions.refetchQueries || _this.props.refetchQueries;
                var mutateVariables = Object.assign({}, variables, mutateOptions.variables);
                delete mutateOptions.variables;
                return _this.currentClient().mutate(tslib.__assign({ mutation: mutation,
            ...
            _this.verifyDocumentIsMutation = function (mutation) {
                ...
                process.env.NODE_ENV === "production" ? tsInvariant.invariant(operation.type === reactCommon.DocumentType.Mutation) : tsInvariant.invariant(operation.type === reactCommon.DocumentType.Mutation, "The <Mutation /> component requires a graphql mutation, but got a " + (operation.type === reactCommon.DocumentType.Query ? 'query' : 'subscription') + ".");
            };
    ...
    var Subscription = (function (_super) {
        ...
        Subscription.prototype.render = function () {
            ...
            if (!renderFn)
                return null;
            var result = tslib.__assign({}, currentState, { variables: this.props.variables });
            this.previousState = currentState;
            this.previousProps = this.props;
            return renderFn(result);
        };
        Subscription.contextType = reactCommon.getApolloContext();
