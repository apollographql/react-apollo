...
var DedupLink = (function (_super) {
    tslib.__extends(DedupLink, _super);
    function DedupLink() {
...
var QueryStore = (function () {
    ...
    QueryStore.prototype.reset = function (observableQueryIds) {
        ...
        this.store = Object.keys(this.store)
            ...
            res[key] = tslib.__assign({}, _this.store[key], { networkStatus: NetworkStatus.loading });
            return res;
        }, {});
    };
    return QueryStore;
...
var MockedProvider = (function (_super) {
    ...
    MockedProvider.prototype.render = function () {
        ...
        return children ? (React.createElement(reactCommon.ApolloProvider, { client: this.state.client }, React.cloneElement(React.Children.only(children), tslib.__assign({}, childProps)))) : null;
    };
