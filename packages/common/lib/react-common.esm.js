...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? invariant(context.client) : invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
function parser(document) {
    ...
    process.env.NODE_ENV === "production" ? invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length)) : invariant(!fragments.length ||
...
export { ApolloConsumer, ApolloProvider, DocumentType, getApolloContext, parser, resetApolloContext };
